            ...
            for r in row:
                ...
                if (v[0] in [
                    ...
                    if v[0] == "SN":
                        ...
                        vals.append("TRUE" if v[1] in
                                    smartSheetSNs else "FALSE")
